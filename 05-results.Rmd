...
gold_bar1 = ggplot(gold_dat, aes(x=reorder(Name,Win.rate),y=GPM)) + geom_bar(stat="identity")+ 
            xlab("Team Names")+
...
jug_bar3 = ggplot(jug_dat, aes(x=reorder(Name,Win.rate),y=HERPG)) + geom_bar(stat="identity") + coord_flip()+ xlab("Teams")+theme(axis.ticks.y = element_blank(), axis.text.y = element_blank(), axis.title.y=element_blank())

jug_bar5 = ggplot(jug_dat, aes(x=reorder(Name,Win.rate),y=NASHPG)) + geom_bar(stat="identity") + coord_flip()+ xlab("Teams")+theme(axis.ticks.y = element_blank(), axis.text.y = element_blank(), axis.title.y=element_blank())
...
jug_bar4 = ggplot(jug_dat, aes(x=reorder(Name,Win.rate),y=HER.)) + geom_bar(stat="identity") + coord_flip()+ xlab("Teams")+theme(axis.ticks.y = element_blank(), axis.text.y = element_blank(), axis.title.y=element_blank())
jug_bar6 = ggplot(jug_dat, aes(x=reorder(Name,Win.rate),y=NASH.)) + geom_bar(stat="identity") + coord_flip()+ xlab("Teams")+theme(axis.ticks.y = element_blank(), axis.text.y = element_blank(), axis.title.y=element_blank())
